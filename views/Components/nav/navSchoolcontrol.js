class NavBarControlEscolar extends HTMLElement {
  constructor() {
    super();
    this.innerHTML = `
            <style>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="generateSchoolRecords.html" onclick="sessionStorage.setItem('fk_id_type_certificates', '1');">
                                            CURSOS IMPARTIDOS
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    ...
                                    <span id="userName"> Control Escolar</span>
...
customElements.define('nav-control-escolar', NavBarControlEscolar);
