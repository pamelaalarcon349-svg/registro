class NavBar extends HTMLElement {
  constructor() {
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li>
                    <a href="requestedCertificatesList.html" id="cursosImpartidos">CURSOS IMPARTIDOS</a>
                  </li>
                  <li>
                    <a href="degreeExamCertificates.html" id="examenGrado">PARTICIPACIÓN DE EXAMEN DE GRADO</a>
                  </li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                  ...
                  <span id="userName">Investigador</span>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="confirmLogout" onclick="closeSession()">Cerrar sesión</button>
            </div>
          </div>
        </div>
      </div>
    ...
    const cursosImpartidos = this.querySelector('#cursosImpartidos');
    const examenGrado = this.querySelector('#examenGrado');

    // Asigna los eventos de clic
    cursosImpartidos.addEventListener('click', () => {
      sessionStorage.setItem('fk_id_type_certificates', 1);
    });

    examenGrado.addEventListener('click', () => {
      sessionStorage.setItem('fk_id_type_certificates', 3);
    });
  }
}
