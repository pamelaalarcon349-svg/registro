class NavBarDegree extends HTMLElement {
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    ...
    if (userData) {
      const userName = userData.nombre_completo || 'Oficina de Examen de Grado';
      const accountName = userData.full_name || 'Nombre de Usuario';
      ...
      case 4: //OFICINA DE EXAMEN DE GRADO Y GRADUADOS
        navContent = `
                ...
                <li class="dropdown">
                    ...
                    <li><a href="examRequestStatus.html" onclick="sessionStorage.setItem('fk_id_type_certificates', '2');">SOLICITUDES DE EXAMEN DE GRADO</a></li>
                    <li><a href="requestedCertificatesInfo.html" onclick="sessionStorage.setItem('fk_id_type_certificates', '3');">PARTICIPACIÓN DE EXAMEN DE GRADO</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <span id="userName"> Oficina de Examen de Grado</span>
...
customElements.define('nav-examdegree', NavBarDegree);
