...
class PHPMailer
{
     ...
     * can't validation addresses with an IDN without knowing the PHPMailer::$CharSet (that can still
    ...
    /**
     * Parse and validation a string containing one or more RFC822-style comma-separated email addresses
    ...
    public function setFrom($address, $name = '', $auto = true)
    {
        ...
        $name = trim(preg_replace('/[\r\n]+/', '', $name)); //Strip breaks and trim
        //Don't validation now addresses with IDN. Will be done in send().
        $pos = strrpos($address, '@');
        if (
            (false === $pos)
