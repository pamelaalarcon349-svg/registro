...
class RequestModel {
     ...
     */
        ...
        try {           
           ...
           if ($resultQ1['status']) 
           {
                ...
                $resultQ2 = $this-> sga_persona_sga_estudiante($id, $register_date, $curp, $birth_date, $birthPlaceCode, $pogramCode );
                ...
                if ($resultQ2['status']) 
                {
                    ...
                    if ($resultQ3['status']) 
                    {
                        ...
                        $resultQ4 = $this-> sga_estudiante_admision( $id, $register_date, $admisionProcessCode, $id_general, $studentProgramPrefix, $processStateCode, $processStageCode);

                        if ($resultQ4['status']) 
                        {
                            $id = $resultQ4['data']['id']; 
                            $resultQ5 = $this-> sga_bitacora_estudiante_admision( $id );
    ...
    function sga_persona(string $name, string $last_name, string $second_last_name, string $genderCode, string $email = null) {
        ...
        try {
            ...
            $tsql = "INSERT dbo.sga_persona (nombre, primer_apellido, segundo_apellido, nombre_completo, genero, numero_cvu, correo_electronico, tipo_persona, estado) OUTPUT"
                . " INSERTED.id VALUES ('" . $name . "', '" . $last_name . "', '" . $second_last_name . "', '" . $name . $last_name . "', '" . $genderCode . "', '', '" . $email . "', '1', '1')"; 
        ...
        function sga_persona_sga_estudiante(string $id, string $registerDate, string $curp, string $birth_date, string $birthPlaceCode, string $programCode = null) {
        ...
        try {
         ...
         //   $registerDate = "'". $registerDate . "'";
            // Query de inserción
            $tsql = "INSERT INTO sga_persona_sga_estudiante (folio_registro_aspirante_, matricula_alummno, numero_registro, fecha_registro_aspirante, curp, dni, rfc, fecha_nacimiento, registro_datos_biometricos, estado_estudiante, estudiante_m2o_id, estado_civil_m2o_id, estado_r1_m2o_id, programa_m2o_id, id) 
            VALUES (null, null, null, CONVERT(datetime, $registerDate, 20), '$curp', null, null, null, null, '1', null, null, '$birthPlaceCode', '$programCode', '$id')";
    ...
    public function sga_estudiante_admision (string $studentId, string $register_date, string $admisionProcessCode, string $id_general, string $studentProgramPrefix, string $processStateCode, string $processStageCode = null) {
        ...
        try {
            ...
            $tsql = "INSERT INTO sga_estudiante_admision (criterio_aprobacion_total, motivo_ingreso, fecha_registro, observaciones, modalidad_ingreso, beca_propedeutico, beca_comedor, estado, estudiante_m2o_id, proceso_admision_m2o_id, estado_proceso_m2o_id, etapa_proceso_m2o_id, idgenerales, especifique) 
              VALUES ('0', '', '$register_date', null, '3', null, null, '1', '$studentId', '$admisionProcessCode', '$processStateCode', '$processStageCode', '$id_general', null)";
           ...
           // se actualiza la tabla de persona_estudiante           
                ...
                $tsql = "UPDATE sga_persona_sga_estudiante SET folio_registro_aspirante_ = '$applicantFolio' WHERE id = $studentId";
    ...
    public function sga_bitacora_estudiante_admision(string $studiantId = null) {
        ...
        try {
            ...
            VALUES ('creacion', '$actionDate', '', '1', '$studiantId', null, '1')";
    ...
    public function sga_usuario_sistema(string $personId, string $userName, string $contrasena, string $registerDate = null) {
        ...
        VALUES ('$userName', '$contrasena', '$registerDate', '1', '$personId')";
   ...
   public function getRequests(){
        try {
            ...
            $tsql = "SELECT * FROM dbo.requests ORDER by id";
            //Insert query
            $insertReview = sqlsrv_query($conn, $tsql);
            if ($insertReview == FALSE) {
                $status = false;
