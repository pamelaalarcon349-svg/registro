...
class RequestModel {
     ...
     */
        ...
        try {           
           ...
           if ($resultQ1['status']) 
           {
                ...
                $resultQ2 = $this-> sga_persona_sga_estudiante($id,$registerDate, $curp, $birth_date, $birthPlaceCode, $pogramCode );
    ...
    function sga_persona_sga_estudiante(string $id, string $registerDate, string $curp, string $birth_date, string $birthPlaceCode, string $programCode ) {
        ...
        try {
            ...
            $tsql = "INSERT INTO sga_persona_sga_estudiante (folio_aspirante, matricula_alumno, numero_registro, fecha_registro_aspirante, curp, dni, rfc, fecha_nacimiento, registro_datos_biometricos, estado_estudiante, estudiante_m2o_id, estado_civil_m2o_id, estado_r1_m2o_id, programa_m2o_id, id) 
            VALUES (null, null, null, CONVERT(datetime,$registerDate, 20), '$curp', null, null,  CONVERT(datetime,$birthDate, 20), null, '1', null, null, '$birthPlaceCode', '$programCode','$id')";
            //Insert query
            $insertReview = sqlsrv_query($conn, $tsql);
            if ($insertReview == FALSE) {
                $status = false;
    ...
    public function sga_bitacora_estudiante_admision(string $studiantId = null) {
        ...
        try {
            ...
            VALUES ('creacion',  CONVERT(datetime,$actionDate, 20), '', '1', '$studiantId', null, '1')";
