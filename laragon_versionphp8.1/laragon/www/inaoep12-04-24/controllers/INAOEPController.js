      ...
      //  if(solicitud.Email !== tempEmail)
       {
        ...
        "<button type='button' class='btn btn-outline-success' onclick='verifyDatas("+JSON.stringify(data)+")'><i class='fa-solid fa-floppy-disk'></i></button>"+
...
function msgSaveData(data) {
    ...
    modalBody.innerHTML = "solicitud de admision registrada correctamente"; 
...
function msgVerifyData(data) {
    ...
    if (data.hasOwnProperty(data)) {
        ...
        modalBody.innerHTML += "<p><strong>" + data + ":</strong> c" + data[data] + "</p>";
    }
