    ...
    exit(json_encode($result));
      ...
      $contrasena = "Ch4NS3O24@+/--";
        ...
        <body>
          ...
          <p>Su nombre correo cuenta con una cuenta de usuario y solictud de admision asociada</p>
          <p>XXX@gmail.com o xxx@hotmail.com o xxx@yahoo.com el nombre de correo XXX es la misma aunque el @dominio de correo sea diferente</p>
          <p>Liga al sistema: <a href='https://www.inaoep.mx/tramites/inscripcion/'>https://www.inaoep.mx/tramites/inscripcion/</a></p>
