...
class RequestModel {
     ...
     */
        ...
        try {           
            ...
            $degree=trim($degree);
            $academic_area=trim($academic_area);
    ...
    function sga_persona(string $name, string $last_name, string $second_last_name, string $genderCode, string $email = null) {
        ...
        try {
            ...
            $tsql = "INSERT dbo.sga_persona (name$name, primer_apellido, segundo_apellido, nombre_completo, genero, numero_cvu, correo_electronico, tipo_persona, estado) OUTPUT"
