...
class Catalogs {
    ...
    public function programCatalog($tipo_posgrado, $degree) {
        ...
        $program = "Maestría en Ciencias en la Especialidad de Astrofísica"; //$degree+' en '+ $tipo_posgrado;
    ...
    public function estadoProcesoId ($degree){
  ...
  // Método para obtener el catálogo de estados
    ...
    public function admisionProcessCatalog($program, $degree){
        ...
        if ($program === 'Maestría Ciencias en la Especialidad de Astrofísica') {
            return '129';
        } elseif ($program === 'Maestría Ciencias en la Especialidad de Electrónica') {
            return'131';
        } elseif ($program === 'Maestría Ciencias en la Especialidad de Óptica') {
            return '130';
        }elseif ($program === 'Maestría Ciencias en el Área de Ciencias Computacionales') {
            return '132';
        } elseif ($program === 'Maestría Ciencias en el Área de Ciencia y Tecnología del Espacio') {
            return '133';
        }elseif ($program === 'Maestría Ciencias y Tecnologías Biomédicas') {
            return '134';
        } elseif ($program === 'Maestría Enseñanza de Ciencias Exactas') {
            return '136';
        }elseif ($program === 'Maestría Ciencias y Tecnologías de Seguridad ') {
            return '137';
        } elseif ($program === 'Doctorado en Ciencias en la Especialidad de Astrofísica') {
            return '116';
        }elseif ($program === 'Doctorado en Ciencias en la Especialidad de Electrónica') {
