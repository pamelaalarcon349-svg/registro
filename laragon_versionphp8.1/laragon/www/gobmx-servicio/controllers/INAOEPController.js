    ...
    for (var key in data)
     {
        ...
        if (data.hasOwnProperty(key) ) {
            ...
            if (data[key]['count'] !== undefined) {
                modalBody.innerHTML += "<p><strong>" + key + ":count</strong> "  + data[key]['count'] + "</p>";
            }
            if (data[key]['email'] !== undefined) {
                modalBody.innerHTML += "<p><strong>" + key + ":email</strong> " + data[key]['email'] + "</p>";
            }
        }
